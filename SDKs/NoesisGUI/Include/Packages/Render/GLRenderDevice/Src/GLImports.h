...
////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    GL_IMPORT(false, PFNGLFRAMEBUFFERRENDERBUFFERPROC, glFramebufferRenderbuffer);
        ...
        GL_IMPORT(true, PFNGLRENDERBUFFERSTORAGEMULTISAMPLEIMG, glRenderbufferStorageMultisampleIMG);
        GL_IMPORT(true, PFNGLFRAMEBUFFERTEXTURE2DMULTISAMPLEIMG, glFramebufferTexture2DMultisampleIMG);
    #endif
