...
////////////////////////////////////////////////////////////////////////////////////////////////////
class NS_APP_APPLICATIONLAUNCHER_API Application: public Noesis::BaseComponent, public Noesis::IUITreeNode
{
public:
    Application();
    ~Application();
    ...
    //@{
    const char* GetStartupUri() const;
    void SetStartupUri(const char* startupUri);
    //@}
