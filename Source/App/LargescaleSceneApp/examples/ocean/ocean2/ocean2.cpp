...
class Ocean2 : public GlfwWindow, public ViewManager
{
public:
    ...
    Ocean2() : GlfwWindow(Window::Parameters().size(1024, 768))
    {
    }
...
class Ocean2Resource : public ResourceTemplate<100, Ocean2>
{
public:
    Ocean2Resource(ptr<ResourceManager> manager, const string &name, ptr<ResourceDescriptor> desc, const TiXmlElement *e = NULL) :
        ResourceTemplate<100, Ocean2> (manager, name, desc)
    {
...
extern const char Ocean2Res[] = "Ocean2";

static ResourceFactory::Type<Ocean2Res, Ocean2Resource> Ocean2Type;

static_ptr<Window> appOcean2;

void initOcean2()
{
    preprocessAtmo(AtmoParameters(), "../../../Source/App/LargescaleSceneApp/examples/ocean/ocean2");
    ...
    resLoader->addPath("../../../Source/App/LargescaleSceneApp/examples/ocean/ocean2");
    resLoader->addPath("../../../Source/App/LargescaleSceneApp/examples/ocean/ocean1");
    resLoader->addArchive("../../../Source/App/LargescaleSceneApp/examples/ocean/ocean2/helloworld.xml");
