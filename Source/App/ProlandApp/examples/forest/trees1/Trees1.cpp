...
#include "Proland/common/ProlandMacro.h"
#include "proland/plugin/TerrainPlugin.h"
#include "proland/plugin/ForestPlugin.h"
...
public:
    ...
    HelloWorld() : GlfwWindow(Window::Parameters().size(1024, 768))
    {
        ...
        resLoader->addPath("G:\\OrkFrame\\Source\\App\\ProlandApp\\examples\\forest\\trees1");
        resLoader->addArchive("G:\\OrkFrame\\Source\\App\\ProlandApp\\examples\\forest\\trees1\\helloworld.xml");
