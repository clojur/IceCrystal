...
#ifndef _Soul_MULTITHREAD_SCHEDULER_H_
#define _Soul_MULTITHREAD_SCHEDULER_H_
...
/**
 * A Scheduler that can use multiple threads. This scheduler can wSoul with one
 ...
 * @ingroup taskgraph
 */
class Soul_API MultithreadScheduler : public Scheduler
{
public:
    /**
