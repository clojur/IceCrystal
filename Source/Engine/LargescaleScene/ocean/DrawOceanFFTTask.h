...
#ifndef _LARGESCALESCENE_DRAW_OCEAN_FFT_TASK_H_
#define _LARGESCALESCENE_DRAW_OCEAN_FFT_TASK_H_
 ...
 * @authors Eric Bruneton, Antoine Begault, Guillaume Piolat
 */
class LargescaleScene_API DrawOceanFFTTask : public AbstractTask
{
public:
    /**
