...
#ifndef _LargescaleScene_EDITOR_HANDLER_H_
#define _LargescaleScene_EDITOR_HANDLER_H_
 ...
 */
class LargescaleScene_API Editor
{
public:
 ...
 */
class LargescaleScene_API EditorHandler : public EventHandler
{
public:
    /**
