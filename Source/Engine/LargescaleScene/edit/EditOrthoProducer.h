...
#ifndef _LargescaleScene_EDIT_ORTHO_PRODUCER_H_
#define _LargescaleScene_EDIT_ORTHO_PRODUCER_H_

#include "LargescaleScene/producer/GPUTileStorage.h"
#include "LargescaleScene/producer/OrthoProducer.h"
 ...
 */
class LargescaleScene_API EditOrthoProducer : public OrthoProducer, public Editor
{
public:
    /**
