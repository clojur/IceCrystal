...
#ifndef _LargescaleScene_ELEVATION_PRODUCER_H_
#define _LargescaleScene_ELEVATION_PRODUCER_H_
 ...
 */
class LargescaleScene_API ElevationProducer : public TileProducer
{
public:
    /**
