...
#ifndef _LargescaleScene_RESIDUAL_PRODUCER_H_
#define _LargescaleScene_RESIDUAL_PRODUCER_H_
 ...
 */
class LargescaleScene_API ResidualProducer : public TileProducer
{
public:
    /**
