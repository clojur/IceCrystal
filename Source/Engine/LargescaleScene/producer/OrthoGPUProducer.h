...
#ifndef _LargescaleScene_ORTHO_GPU_PRODUCER_H_
#define _LargescaleScene_ORTHO_GPU_PRODUCER_H_
 ...
 * @authors Eric Bruneton, Antoine Begault, Guillaume Piolat
 */
class LargescaleScene_API OrthoGPUProducer : public TileProducer
{
public:
    /**
