...
#ifndef _LargescaleScene_ORTHO_CPU_PRODUCER_H_
#define _LargescaleScene_ORTHO_CPU_PRODUCER_H_
 ...
 */
class LargescaleScene_API OrthoCPUProducer : public TileProducer
{
public:
    /**
