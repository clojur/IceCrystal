...
#ifndef _LargescaleScene_TERRAIN_VIEW_CONTROLLER_H_
#define _LargescaleScene_TERRAIN_VIEW_CONTROLLER_H_
...
/**
 * @defgroup LargescaleScene_util util
 ...
 * @authors Eric Bruneton, Antoine Begault, Guillaume Piolat
 */
class LargescaleScene_API TerrainViewController : public Object
{
public:
    /**
