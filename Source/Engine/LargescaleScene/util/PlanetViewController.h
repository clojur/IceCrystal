...
#ifndef _LargescaleScene_PLANET_VIEW_CONTROLLER_H_
#define _LargescaleScene_PLANET_VIEW_CONTROLLER_H_
 ...
 * @authors Eric Bruneton, Antoine Begault, Guillaume Piolat
 */
class LargescaleScene_API PlanetViewController : public TerrainViewController
{
public:
    /**
