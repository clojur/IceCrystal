...
LargescaleScene_API int mfs_open (void *ptr, int size, char *mode, mfs_file *fd);
LargescaleScene_API int mfs_lseek (mfs_file *fd, int offset, int whence);
LargescaleScene_API int mfs_read (mfs_file *fd, void *buf, int size);
LargescaleScene_API int mfs_write (mfs_file *fd, void *buf, int size);
LargescaleScene_API int mfs_size (mfs_file *fd);
LargescaleScene_API int mfs_map (mfs_file *fd, char **addr, size_t *len);
LargescaleScene_API int mfs_unmap (mfs_file *fd);
LargescaleScene_API int mfs_close (mfs_file *fd);
