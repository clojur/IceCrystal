...
#ifndef _LargeScaleScene_GRAPH_PRODUCER_H_
#define _LargeScaleScene_GRAPH_PRODUCER_H_
...
#include "LargescaleScene/graph/graph/BasicGraph.h"
...
class LargescaleScene_API GraphProducer:public GraphListener,public TileProducer
{
public:
    /**
