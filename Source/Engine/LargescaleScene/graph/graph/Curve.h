...
#ifndef _LargescaleScene_CURVE_H_
#define _LargescaleScene_CURVE_H_
 ...
 */
struct LargescaleScene_API Vertex : public vec2d
{
    /**
 ...
 */
class LargescaleScene_API Curve : public Object
{
