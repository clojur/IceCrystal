...
#ifndef _LargescaleScene_ROADELEVATIONLAYER_H_
#define _LargescaleScene_ROADELEVATIONLAYER_H_
 ...
 */
class LargescaleScene_API RoadElevationLayer : public ElevationGraphLayer
{
public:
    /**
