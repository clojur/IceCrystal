...
#ifndef _LargescaleScene_PARTICLE_STORAGE_H_
#define _LargescaleScene_PARTICLE_STORAGE_H_
 ...
 * Provides a framewSoul to produce, animate and store %particles.
 ...
 * @authors Eric Bruneton, Antoine Begault, Guillaume Piolat
 */
class LargescaleScene_API ParticleStorage : public Object
{
public:
    /**
     ...
     * Soul::MeshBuffers (via an Soul::AttributeBuffer) to
