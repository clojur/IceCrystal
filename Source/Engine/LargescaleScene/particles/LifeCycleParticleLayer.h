...
#ifndef _LargescaleScene_LIFECYCLE_PARTICLE_LAYER_H_
#define _LargescaleScene_LIFECYCLE_PARTICLE_LAYER_H_
 ...
 */
class LargescaleScene_API  LifeCycleParticleLayer : public ParticleLayer
{
public:
    /**
