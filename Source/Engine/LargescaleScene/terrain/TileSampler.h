...
#ifndef _LargescaleScene_UNIFORM_SAMPLER_TILE_H_
#define _LargescaleScene_UNIFORM_SAMPLER_TILE_H_
...
/**
 * A Soul::Uniform to access texture tiles stored on GPU. This class can
 * set the GLSL uniforms necessary to access a given texture tile on GPU, stored
 * in a LargescaleScene::GPUTileStorage. This class also manages the creation
 * of new texture tiles when a %terrain quadtree is updated, via a
 * LargescaleScene::TileProducer.
 * @ingroup terrain
 * @authors Eric Bruneton, Antoine Begault
 */
class LargescaleScene_API  TileSampler : public Object
{
public:
    /**
     ...
     *      LargescaleScene::GPUTileStorage.
     */
     ...
     * a LargescaleScene::GPUTileStorage.
     *
...
private:
    ...
    /**
     * The texture sampler to access the LargescaleScene::GPUTileStorage.
     */
    ptr<UniformSampler> samplerU;

    /**
     * The coordinates of a tile in the LargescaleScene::GPUTileStorage.
     */
    ptr<Uniform3f> coordsU;

    /**
     * The relative size of a tile in the LargescaleScene::GPUTileStorage.
     */
    ptr<Uniform3f> sizeU;
