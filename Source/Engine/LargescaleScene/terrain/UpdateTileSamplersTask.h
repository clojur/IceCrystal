...
#ifndef _LargescaleScene_UPDATE_UNIFORM_TASK_H_
#define _LargescaleScene_UPDATE_UNIFORM_TASK_H_
 ...
 */
class LargescaleScene_API  UpdateTileSamplersTask : public AbstractTask
{
public:
    /**
