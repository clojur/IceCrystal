...
#ifndef _LargescaleScene_UNIFORM_SAMPLER_TILEZ_H_
#define _LargescaleScene_UNIFORM_SAMPLER_TILEZ_H_

#include <set>

#include "Soul/core/Factory.h"

#include "LargescaleScene/producer/GPUTileStorage.h"
#include "LargescaleScene/terrain/ReadbackManager.h"
...
/**
 * A TileSampler to be used with a LargescaleScene::ElevationProducer.
 ...
 */
class LargescaleScene_API  TileSamplerZ : public TileSampler
{
public:
    /**
...
private:
    ...
    /**
     * A Soul::ReadbackManager::Callback to readback an
    ...
    /**
     * The Soul::Factory to create shared State objects for a given
     * tile storage.
     */
