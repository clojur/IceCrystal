...
#ifndef _LargescaleScene_CYLINDRICAL_DEFORMATION_H_
#define _LargescaleScene_CYLINDRICAL_DEFORMATION_H_
 ...
 */
class LargescaleScene_API  CylindricalDeformation : public Deformation
{
public:
    /**
