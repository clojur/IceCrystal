...
#ifndef _LargescaleScene_SPHERICAL_DEFORMATION_H_
#define _LargescaleScene_SPHERICAL_DEFORMATION_H_
 ...
 * @authors Eric Bruneton, Antoine Begault, Guillaume Piolat
 */
class LargescaleScene_API  SphericalDeformation : public Deformation
{
public:
    /**
