...
#ifndef _LargescaleScene_NOISE_H_
#define _LargescaleScene_NOISE_H_
...
/**
 * @defgroup LargescaleScene_math math
 ...
 */
LargescaleScene_API inline long lrandom(long *seed)
{
 ...
 */
LargescaleScene_API inline float frandom(long *seed)
{
 ...
 */
LargescaleScene_API inline float grandom(float mean, float stdDeviation, long *seed)
{
    float x1, x2, w, y1;
    static float y2;
 ...
 */
LargescaleScene_API float cnoise(float x, float y, int P = 0);
 ...
 *      function has a main frequency of 1, and its value are between -1 and 1.
 */
LargescaleScene_API float cnoise(float x, float y, float z, int P = 0);
 ...
 *      function has a main frequency of 1, and its value are between -1 and 1.
 */
LargescaleScene_API float snoise(float x, float y, int P = 0);
 ...
 *      function has a main frequency of 1, and its value are between -1 and 1.
 */
LargescaleScene_API float snoise(float x, float y, float z, int P = 0);
 ...
 *      function has a main frequency of 1, and its value are between -1 and 1.
 */
LargescaleScene_API float snoise(float x, float y, float z, float w, int P = 0);
 ...
 */
LargescaleScene_API float *buildFbm4NoiseTexture2D(int size, int freq, int octaves, int lacunarity, float gain);
 ...
 */
LargescaleScene_API float *buildFbm1NoiseTexture3D(int size, int freq, int octaves, int lacunarity, float gain);
