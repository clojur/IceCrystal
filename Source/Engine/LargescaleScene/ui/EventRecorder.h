...
#ifndef _LargescaleScene_EVENTRECORDER_H_
#define _LargescaleScene_EVENTRECORDER_H_
#include"LargescaleSceneMacro.h"
#include <vector>

#include "Soul/core/Timer.h"
 ...
 * @authors Eric Bruneton, Antoine Begault, Guillaume Piolat
 */
class LargescaleScene_API  Recordable
{
public:
    /**
 ...
 * @ingroup LargescaleScene_ui
 */
class LargescaleScene_API  EventRecorder : public EventHandler
{
public:
    /**
     * A recorded event.
