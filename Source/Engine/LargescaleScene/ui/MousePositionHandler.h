...
#ifndef _LargescaleScene_MOUSEPOSITIONHANDLER_H_
#define _LargescaleScene_MOUSEPOSITIONHANDLER_H_
 ...
 */
class LargescaleScene_API  MousePositionHandler : public EventHandler
{
public:
    /**
