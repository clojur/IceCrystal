...
#ifndef _LargescaleScene_TWEAKBARMANAGER_H_
#define _LargescaleScene_TWEAKBARMANAGER_H_
 ...
 */
class LargescaleScene_API  TweakBarManager : public EventHandler
{
public:
    /**
     * A TweakBarHandler with additional options.
     */
    struct LargescaleScene_API BarData
    {
    public:
        /**
