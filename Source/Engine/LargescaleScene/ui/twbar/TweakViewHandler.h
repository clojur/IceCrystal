...
#ifndef _LargescaleScene_TWEAKVIEWHANDLER_H_
#define _LargescaleScene_TWEAKVIEWHANDLER_H_
 ...
 */
class LargescaleScene_API  TweakViewHandler : public TweakBarHandler
{
public:
    /**
