...
#ifndef _LargescaleScene_SCENEVISITOR_H_
#define _LargescaleScene_SCENEVISITOR_H_
...
/**
 * @defgroup LargescaleScene_ui ui
 ...
 */
class LargescaleScene_API  SceneVisitor : public Object
{
public:
    /**
