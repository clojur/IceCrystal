...
#ifndef _LargescaleScene_BASICVIEWHANDLER_H_
#define _LargescaleScene_BASICVIEWHANDLER_H_
 ...
 */
class LargescaleScene_API  ViewManager
{
public:
    /**
...
class LargescaleScene_API  BasicViewHandler : public EventHandler
{
public:
