...
#ifndef _LargescaleScene_DRAWRIVERSTASK_H_
#define _LargescaleScene_DRAWRIVERSTASK_H_
 ...
 * Provides a framewSoul to draw animated %rivers on top of a %terrain.
 ...
 */
class LargescaleScene_API  DrawRiversTask : public AbstractTask
{
public:
