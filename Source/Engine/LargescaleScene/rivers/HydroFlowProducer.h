...
#ifndef _LargescaleScene_HYDROFLOWPRODUCER_H
#define _LargescaleScene_HYDROFLOWPRODUCER_H
 ...
 */
class LargescaleScene_API  HydroFlowProducer : public TileProducer, public CurveDataFactory
{
public:
    /**
